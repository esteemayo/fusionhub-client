  ...
  return (
    <div className='comment-filters'>
      ...
      <div className='comment-filters__wrapper'>
        ...
        <div onClick={onToggle} className='comment-filters__options'>
          <span className='comment-filters__options--value'>Best</span>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 24 24'
            fill='currentColor'
            className='size-6 comment-filters__options--icon'
          >
            <path
              fillRule='evenodd'
