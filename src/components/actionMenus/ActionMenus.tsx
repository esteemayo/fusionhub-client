...
import ActionMenuSkeleton from '../actionMenuSkeleton/ActionMenuSkeleton';
  ...
  return (
    <section className='action-menus'>
      <div className='action-menus__container'>
        <h2 className='action-menus__container--heading'>Actions</h2>
        {isLoading ? (
          <ActionMenuSkeleton />
        ) : (
        ...
        {isLoading ? (
          ...
          <div className='action-menus__action'>
            ...
            >
              ...
              <span className='action-menus__btn--label'>Share post</span>
              {isPending && (
                <span className='action-menus__btn--loader success'>
                  (in progress)
                </span>
