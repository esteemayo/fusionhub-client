        ...
        <div className='accountMenu__wrapper'>
          <ul className='accountMenu__list'>
            ...
            <li className='accountMenu__list--item'>
              ...
              <Link to='/accounts/my-posts'>Articles</Link>
            </li>
            <li className='accountMenu__list--item'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <Link to='/accounts/saved-posts'>Saved posts</Link>
            </li>
            <li className='accountMenu__list--item'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <Link to='/accounts/liked-posts'>Likes</Link>
            </li>
            <li className='accountMenu__list--item'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <Link to='/accounts/disliked-posts'>Dislikes</Link>
            </li>
            <li className='accountMenu__list--item'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
            ...
            <li className='accountMenu__list--item'>
              ...
              <Link to='/accounts/password-settings'>Password settings</Link>
            </li>
          </ul>
        </div>
