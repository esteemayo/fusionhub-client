...
const ProfileDetails = ({
  ...
  const dateRegistered = useMemo(() => {
    const formattedDate = new Date(createdAt).toLocaleString('us', {
      month: 'long',
      year: 'numeric',
    });
  ...
  return (
    <section className='profile-details'>
      <div className='profile-details__container'>
        <h3 className='profile-details__container--username'>{name}</h3>
      ...
      <div className='profile-details__wrap'>
        ...
        <div className='profile-details__wrap--box'>
          ...
          {dateOfBirth && <span>Born {formatDate(dateOfBirth as string)}</span>}
        </div>
        <div className='profile-details__wrap--box'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
